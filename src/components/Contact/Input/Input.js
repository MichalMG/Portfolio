  ...
  return (<div className="col-12 col-lg-6">
    <div className="mb-2">
      <label className="input__container">
        ...
        <span className="input__container-placeholder">{props.title}</span>
        <span className="input__container-border"></span>
        {props.valid
          ? <span className="input__container-ico">
        ...
        {props.message
          ? (<>
            ...
            <div className="p-0 m-0 text-myorange input__container-validation-message">{props.message}</div>
          </>
          )
          : null}
      </label>
  ...
  return (
    <div className="col-12">
      <div className={`${props.message ? "mb-0" : "mb-3"}`}>
        ...
        <div className="invalid-feedback p-0 m-0 ms-3 text-danger">{props.message}</div>
      </div>
    </div>
  )
}
